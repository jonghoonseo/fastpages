...
#  Default: ''
import os
c.NotebookApp.notebook_dir = os.path.dirname(__file__)
...
#  Default: ''
c.NotebookApp.password = 'argon2:$argon2id$v=19$m=10240,t=10,p=8$6mSQ0DJz9X4G0nUmKiuALg$SPsHOrMZs3g/QuWlxwjM4Q'
...
#  Choices: any of ['sha384', 'blake2b', 'sha3_384', 'sha3_256', 'sha512', 'sha224', 'blake2s', 'sha256', 'sha1', 'sha3_224', 'sha3_512', 'md5']
#  Default: 'sha256'
